...
import getSalesRepEvents from '@salesforce/apex/EDDSalesRepActivitiesController.getSalesRepEvents';
import getSalesReps from '@salesforce/apex/EDDSalesRepActivitiesController.getSalesReps';
import getEventChecksum from '@salesforce/apex/EDDSalesRepActivitiesController.getEventChecksum';

export default class EddSalesRepsActivity extends NavigationMixin(LightningElement) {
    salesReps = [];
    allEvents = [];
    timeSlots = [];
    calendarGrid = [];
